...
# rental_object.rent_car("Conor Reilly", "4 Series", 2019, 13, 4)
# rental_object.rent_car("Conor Reilly", "4 Series", 2019.1, 13, 4)
# rental_object.rent_car("Conor Reilly", "4 Series", 2019, 12, 4)
# rental_object.rent_car("david zhou", "4 Series", 2013, 1, 3)
print(rental_object.return_cars_rented())
rental_object.end_rental("Conor Reilly", "4 Series", 2020, 2, 5)
# rental_object.end_rental("david zhou", "4 Series", 2013, 3, 21)
