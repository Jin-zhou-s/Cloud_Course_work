...
# rental_object.rent_car("Conor Reilly", "3 Series", 2019, 1, 4)
# rental_object.rent_car("david zhou", "3 Series", 2013, 1, 3)
print(rental_object.return_cars_rented())
# rental_object.end_rental("Conor Reilly", "4 Series", 2019, 2, 5)
# rental_object.end_rental("david zhou", "3 Series", 2013, 3, 20)
# rental_object.delete_car("4 Series")
# rental_object.delete_user("david zhou")
# print("Conor Reilly recording:")
print(rental_object.user_rental_date("Conor Reilly", 2010, 1, 1, 2029, 2, 1))
print(rental_object.user_rental_date("david zhou", 2010, 1, 1, 2029, 2, 1))
